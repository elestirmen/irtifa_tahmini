...
"""
x_train_u=np.load("x_train_u.npy")
irtifa_u=np.load("irtifa_u.npy")

x_train_k=np.load("x_train_k.npy")
irtifa_k=np.load("irtifa_k.npy")


x_train= np.concatenate((x_train_u, x_train_k))
irtifa = np.concatenate((irtifa_u, irtifa_k))
